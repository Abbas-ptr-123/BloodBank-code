        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeekerId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Userlist", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Userlist_Donors_DonorId",
                        column: x => x.DonorId,
                        principalTable: "Donors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Userlist_Seekers_SeekerId",
                        column: x => x.SeekerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Userlist_DonorId",
                table: "Userlist",
                column: "DonorId");

            migrationBuilder.CreateIndex(
                name: "IX_Userlist_SeekerId",
                table: "Userlist",
                column: "SeekerId");
        }
